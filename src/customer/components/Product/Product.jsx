...
export default function Product() {
  ...
  const radioFilterHandler = (e ,sectionId) => {
...
{singleFilter.map((section) => (
        ...
        <main className="mx-auto max-w-full px-4 sm:px-6 lg:px-14">
          <div className="flex items-baseline justify-between border-b border-gray-200 pb-6 pt-24">
            <h1 className="text-2xl sm:text-4xl font-bold tracking-tight text-gray-900">New Arrivals</h1>
                        ...
                        <Disclosure.Panel className="pt-6">
                          ...
                          <RadioGroup
                            ...
                            {section.options.map((option, optionIdx) => (
                             ...
                             <>
                                <FormControlLabel onChange={(e) => radioFilterHandler(e,section.id)} value={option.value} control={<Radio />} label={option.label} />
