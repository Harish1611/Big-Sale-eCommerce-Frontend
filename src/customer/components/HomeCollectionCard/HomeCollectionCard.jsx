...
const HomeCollectionCard = ({ product }) => {
  return (
    <div className="cursor-pointer flex flex-col items-center bg-white rounded-md shadow-lg overflow-hidden w-[19rem] mx-2 sm:w-[15rem] sm:m-4 z-10">
      <div className=" h-[23rem] sm:h-[15rem] w-full ">
        <img
