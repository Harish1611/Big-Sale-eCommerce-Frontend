...
const HomeCollectionCard = ({ product }) => {
  return (
    <div className="cursor-pointer flex flex-col items-center bg-white rounded-md shadow-lg overflow-hidden w-[21rem]  sm:w-[15rem] m-4 z-10">
      <div className=" h-[24rem] sm:h-[15rem] w-full">
        <img
